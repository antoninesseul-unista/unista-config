...
export const NAV_SECTIONS = {
  global: [
    ...
    },
    {
      ...
      icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />`,
    },
    {
      label: "Alarms & Faults",
      to: { name: "faults" },
  ...
  architecture: [
    ...
    },
    {
      ...
      icon: `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 11h8M8 15h8M4 6h16a2 2 0 012 2v12a2 2 0 01-2 2H4a2 2 0 01-2-2V8a2 2 0 012-2z" />`,
    },
    {
      label: "Cycle Buttons",
